...
Do not respond with plain text when a tool can be used; call the tool. If the user asks a simple question that can be solved without checking files, avoid using the tool.  
